...
:GccLinker
	...
	%LinkerFilePath% -m %PEFileFormat% -o %CompilerOutputFileName% -subsystem %Win32Subsystem% -e %EntryPoint% --stack 1048576,1048576 --gc-sections %LinkerStripFlag% -L %CompilerLibDirectoryPath% -L "." %AllObjectFiles% -( %AllObjectLibraries% -)
